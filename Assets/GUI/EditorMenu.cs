...
public class EditorMenu : MonoBehaviour {
	...
	void Start () {
        ...
        /*cursor = new GameObject(name);
        Mesh plane = cursor.AddComponent<MeshFilter>().mesh;
        cursor.AddComponent<MeshRenderer>();
        plane.vertices = Maps._Vertices;
        plane.uv = Maps._UV;
        plane.triangles = Maps._Indices;
        plane.normals = Maps._Normal;
        cursor.renderer.material = cursor_mat;*/
